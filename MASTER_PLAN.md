...
| 2 | PMS Engine (Reservations/Inventory/Check-in-out) | 🟡 | 90% | Create wizard, **modify/reprice**, cancel, check-in/out, availability, **inventory calendar + room blocking**, **cancellation policies** (free-window + penalty rules → auto refund/fee on cancel across PMS/OTA/guest, records REFUNDED payment) ✅. Missing: group reservations |
